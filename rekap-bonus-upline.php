<?php
    ...
    include "config/rekapBonusUplineConfig.php"; // STATUS ORDER 
?>
...
<head>
    ...
    <meta charset="utf-8" />
    <title> REKAP BONUS MATCHING | NRJ TOUR</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">REKAP BONUS MATCHING</h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex text-muted">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            ...
                                            <h5 class="mb-3">Rp.<?= totalBonus($startMonth, $endMonth) ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-body -->
