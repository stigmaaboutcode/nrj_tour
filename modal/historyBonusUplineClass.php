<?php  
// CLASS USER
class historyBonusUplineClass extends ConnectionsClass{

    // SET ATTRIBUTE TABLE NAME
    private $table_name = "history_bonus_upline";
    ...
    // INSERT TABLE
    public function insertHistoryBonusUpline(?string $value1 = null, ?string $value2 = null, ?string $value3 = null, ?string $value4 = null, ?string $value5 = null, ?string $value6 = null){
        // SET QUERY
        $sql = "INSERT INTO " . $this->table_name . " (
            code_order,
            code_referral,
            code_referral_downline,
            category,
            nominal,
            date
        ) VALUES(
    ...
    // SELECT TABLE
    public function selectHistoryBonusUpline(?string $param = null, ?string $key1 = null, ?string $key2 = null, ?string $key3 = null, ?string $key4 = null){
        // SET QUERY
        if($param == "allData"){
