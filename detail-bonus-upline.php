<?php
    ...
    include "config/detailBonusUplineConfig.php"; // STATUS ORDER 
?>
...
<head>
    ...
    <meta charset="utf-8" />
    <title> DETAIL BONUS MATCHING | NRJ TOUR</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">DETAIL BONUS MATCHING</h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-sm">
                                            ...
                                            <input type="date" id="dari" value="<?= $startMonth ?>" name="from"class="form-control form-control-sm" required>
                                        </div>
                                        <div class="col-12 col-sm">
                                ...
                                <div class="card-body">
                                    <div class="d-flex text-muted">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            ...
                                            <h5 class="mb-3">Rp.<?= totalBonus($startMonth, $endMonth, $userID) ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-body -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-striped dt-responsive table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?= dataTable($startMonth, $endMonth, $userID) ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
