<?php
    ...
    include "config/settingPasswordUserConfig.php"; // STATUS ORDER
?>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>GANTI PASSWORD | NRJ TOUR</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 mx-auto">
                            <div class="card">
                                <div class="card-body">
                                    <h1 class="card-title">Setting Password</h1>
                                    <hr>
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            <label for="password" class="form-label">Password Anda</label>
                                            <input type="password" class="form-control form-control-sm" id="password"
                                                name="password" required placeholder="Password Lama Anda">
                                        </div>
                                        <div class="mb-3">
                                            <label for="passbaru" class="form-label">Password Baru</label>
                                            <input type="password" class="form-control form-control-sm" id="passbaru"
                                                name="passbaru" required placeholder="Paswword Baru Anda">
                                        </div>
                                        <div class="mb-3">
                                            <label for="passConfirm" class="form-label">Konfirmasi Password</label>
                                            <input type="password" class="form-control form-control-sm" id="passConfirm"
                                                name="passConfirm" required placeholder="Konfirmasi Password">
                                        </div>
                                        <hr>
