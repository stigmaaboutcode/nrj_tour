<?php
    ...
    include "config/akunBankUserConfig.php"; // STATUS ORDER
?>
                                    ...
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="bankName"
                                                name="bankName" required placeholder="Masukkan Nama Bank" value="<?= dataBankUser()['nama_bank'] ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="accountName" class="form-label">Atas Nama</label>
                                            <input type="text" class="form-control form-control-sm" id="accountName"
                                                name="accountName" required placeholder="Masukkan Atas Nama" value="<?= dataBankUser()['atas_nama'] ?>">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="accountNumber"
                                                name="accountNumber" required placeholder="Masukkan Nomor Rekening" value="<?= dataBankUser()['no_rek'] ?>">
                                        </div>
                                        <hr>
