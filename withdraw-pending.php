<?php
    ...
    include "config/withdrawPendingConfig.php"; // STATUS ORDER 
?>
...
<head>
    ...
    <meta charset="utf-8" />
    <title> WITHDRAW KOMISI | NRJ TOUR</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Withdraw Komisi</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a
                                                href="javascript: void(0);">Permintaan</a>
                                        </li>
